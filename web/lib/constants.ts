...
const uploadPathConfig: {
...
}[] = [
  {
    ...
    function: () => ({
      ...
      allowedMimeTypes: ["image/png", "image/jpeg", "video/mp4", "video/quicktime", "video/x-matroska"] as const,
    }),
  },
];
...
export const S3_ALLOWED_EXTENSIONS = [".jpg", ".jpeg", ".png", ".mp4", ".mov", ".mkv"] as const;
